         ...
         <div class="card-body bg-secondary">
           <div class="input-group input-group-lg">
             ...
             <div class="input-group-append" id="button-addon4">
               <button class="btn btn-light btn-lg" disabled type="button">{{timer}} sn.</button>
               <button :disabled="isRunning" class="btn btn-light btn-lg" type="button" @click="getWords">Yenile</button>
             </div>
           </div>
         </div>
       </div>
